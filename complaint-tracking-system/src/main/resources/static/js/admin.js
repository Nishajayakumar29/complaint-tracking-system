...
window.onload = function () {
  ...
  if (currentPage.includes("view-complaints.html")) {
    // Load view-only complaints (without Edit button)
    fetchAllComplaintsUser();
  } else if (currentPage.includes("admin-update-status.html")) {
    // Load complaints with Edit buttons
    fetchAllComplaints();
  } else if (currentPage.includes("completed-complaints.html")) {
